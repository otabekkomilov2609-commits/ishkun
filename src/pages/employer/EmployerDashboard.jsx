          ...
          {shifts.slice(0, 6).map(s => {
            ...
            return (
              <div key={s.id} className="relative">
                ...
                {count > 0 && (
                  <span className="pointer-events-none absolute top-3 right-3 inline-flex items-center gap-1 rounded-full bg-primary text-primary-foreground text-xs font-semibold px-2 py-0.5">
